...
//下注区域索引
#define AREA_1_2					0								//1_6 索引
#define AREA_1_3					1								//1_5 索引
#define AREA_1_4					2								//1_4 索引
#define AREA_1_5					3								//1_3 索引
#define AREA_1_6					4								//1_2 索引
#define AREA_2_3					5								//2_6 索引
#define AREA_2_4					6								//2_5 索引
#define AREA_2_5					7								//2_4 索引
#define AREA_2_6					8								//2_3 索引
#define AREA_3_4					9								//3_6 索引
#define AREA_3_5					10								//3_5 索引
#define AREA_3_6					11								//3_4 索引
#define AREA_4_5					12								//4_6 索引
#define AREA_4_6					13								//4_5 索引
...
{
    int								nTimeLeave;							//剩余时间
    BYTE							nWayItem[6][10];//0无道具、1加速、2减速
    BYTE							cbHorsesRanking[RANKING_NULL];		//名次
    
    int								nPlayerMultiple;
    LONGLONG						lPlayerWinning;						//玩家输赢
    LONGLONG						lPlayerReturnBet;					//玩家返回下注
    LONGLONG						lPlayerCaiChi;
    
    char							szNickName[5][32];
    LONGLONG						lScore[5];
    LONGLONG						lCaiChi[5];
};
...
struct CMD_C_ControlApplication1
{
