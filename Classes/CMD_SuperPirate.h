...
//  CatchFish
//
//  Created by songwu on 15/7/17.
//
//

#ifndef CatchFish_CMD_SuperPirate_h
#define CatchFish_CMD_SuperPirate_h

#pragma pack(1)

#define GAME_GENRE				   (GAME_GENRE_GOLD|GAME_GENRE_MATCH)
#define SCROLL_PICTURE_COUNT		3
...
#define SUB_S_SEND_USEITEM_RESLUT         125                           //图片转动(用道具)
...
struct CMD_S_CHANGE_BET
{
	...
	LONGLONG		 lUserScore;					   	 //玩家金币数量
	LONGLONG		 lDefultChip;					     //默认消耗金币量
    BYTE			 cbCanChange;						 //结果1.成功。2.不能再增加赌注。3.不能小于默认值。
};
